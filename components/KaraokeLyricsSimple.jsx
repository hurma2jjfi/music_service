  ...
  return (
    <div className="karaoke">
      {(trackTitle || artistName) && (
        ...
        <h2 className="karaoke__title">
          <marquee behavior="scroll" direction="left" scrollamount="5" loop="infinite" onMouseOver={e => e.currentTarget.stop()} onMouseOut={e => e.currentTarget.start()}>
            {trackTitle}
          </marquee>
        </h2>
        {artistName && (
          <p className="karaoke__artist">
            <marquee behavior="scroll" direction="left" scrollamount="5" loop="infinite" onMouseOver={e => e.currentTarget.stop()} onMouseOut={e => e.currentTarget.start()}>
              {artistName}
            </marquee>
          </p>
